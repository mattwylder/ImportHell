#
#  Be sure to run `pod spec lint ImportHell.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Matthew Wylder"
  # spec.authors            = { "Matthew Wylder" => "email@address.com" }
  # spec.social_media_url   = "https://twitter.com/Matthew Wylder"
